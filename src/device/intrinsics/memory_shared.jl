...
@generated function generate_static_shmem(::Type{Val{ID}}, ::Type{T}, ::Type{Val{D}}) where {ID,T,D}
...
@generated function generate_dynamic_shmem(::Type{Val{ID}}, ::Type{T}, dims, offset) where {ID,T}
